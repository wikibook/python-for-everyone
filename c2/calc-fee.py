...
if total_num >= 10:
    ...
    print("단체 할인되지 않습니다.")
# 결과 표시
print("어린이 요금  :{0}명x 5000= {1}원".format(children, children_price))
print("보통 요금  :{0}명x10000= {1}원".format(normal, normal_price))
print("경로우대요금:{0}명x 7000= {1}원".format(elder, elder_price))
